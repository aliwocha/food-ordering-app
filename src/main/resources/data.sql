...
(1, 22.50, 'Pizza Margherita', 'Włoska pizza na cienkim cieście z serem i sosem pomidorowym', '/img/margherita.jpg',
...
(2, 25.90, 'Pizza Capriciosa', 'Pizza na cienkim cieście z serem, sosem pomidorowym i pieczarkami', '/img/capriciosa.jpg',
...
(3, 24.90, 'Spaghetti Bolognese', 'Robiona na miejscu pasta z sosem pomidorowym i wołowiną', '/img/spaghetti.jpg',
 'Idealna propozycja dla każdego miłośnika pasty. Spaghetti bolognese w naszym wykonaniu to ręcznie przygotowany ' ||
 'makaron z sosem pomidorowym oraz wysokiej jak ości wołowiną. Do przygotowania sosu wykorzystujemy pomidory z ' ||
 'lokalnych upraw oraz świeże zioła.'),
(4, 18.90, 'Panna Cotta', 'Klasyczny włoski deser o smaku śmietankowym z polewą z truskawek', '/img/panna-cotta.jpg',
